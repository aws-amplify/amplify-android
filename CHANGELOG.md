...
### Miscellaneous
- release: Apollo AppSync Extensions 1.2.0 ([#3014](https://github.com/aws-amplify/amplify-android/issues/3014))
- ci: Add instrumentation test log parsing and reporting to our test automation scripts ([#3003](https://github.com/aws-amplify/amplify-android/issues/3003))
