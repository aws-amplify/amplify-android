...
dependencies {
    ...
    implementation 'com.amplifyframework:aws-analytics-pinpoint:1.32.1'
    ...
    implementation 'com.amplifyframework:aws-predictions:1.32.1'
    implementation 'com.amplifyframework:aws-storage-s3:1.32.1'
}
```
