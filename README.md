...
dependencies {
    ...
    implementation 'com.amplifyframework:aws-analytics-pinpoint:2.39.0'
    implementation 'com.amplifyframework:aws-api:2.39.0'
    implementation 'com.amplifyframework:aws-auth-cognito:2.39.0'
    implementation 'com.amplifyframework:aws-datastore:2.39.0'
    implementation 'com.amplifyframework:aws-predictions:2.39.0'
    implementation 'com.amplifyframework:aws-storage-s3:2.39.0'
    implementation 'com.amplifyframework:aws-geo-location:2.39.0'
    implementation 'com.amplifyframework:aws-push-notifications-pinpoint:2.39.0'
}
```
