...
dependencies {
    ...
    implementation 'com.amplifyframework:aws-analytics-pinpoint:1.6.0'
    implementation 'com.amplifyframework:aws-api:1.6.0'
    implementation 'com.amplifyframework:aws-auth-cognito:1.6.0'
    implementation 'com.amplifyframework:aws-datastore:1.6.0'
    implementation 'com.amplifyframework:aws-predictions:1.6.0'
    implementation 'com.amplifyframework:aws-storage-s3:1.6.0'
}
```
