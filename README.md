...
dependencies {
    ...
    implementation 'com.amplifyframework:aws-datastore:1.17.7'
    implementation 'com.amplifyframework:aws-predictions:1.17.7'
    implementation 'com.amplifyframework:aws-storage-s3:1.17.7'
}
```
