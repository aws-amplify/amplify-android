...
dependencies {
    ...
    implementation 'com.amplifyframework:aws-analytics-pinpoint:2.15.0'
    ...
    implementation 'com.amplifyframework:aws-predictions:2.15.0'
    implementation 'com.amplifyframework:aws-storage-s3:2.15.0'
    implementation 'com.amplifyframework:aws-geo-location:2.15.0'
    implementation 'com.amplifyframework:aws-push-notifications-pinpoint:2.15.0'
}
```
