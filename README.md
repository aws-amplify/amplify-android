...
dependencies {
    ...
    implementation 'com.amplifyframework:aws-analytics-pinpoint:2.7.1'
    ...
    implementation 'com.amplifyframework:aws-predictions:2.7.1'
    implementation 'com.amplifyframework:aws-storage-s3:2.7.1'
    implementation 'com.amplifyframework:aws-geo-location:2.7.1'
    implementation 'com.amplifyframework:aws-push-notifications-pinpoint:2.7.1'
}
```
