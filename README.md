...
dependencies {
    ...
    implementation 'com.amplifyframework:aws-datastore:1.35.2'
    implementation 'com.amplifyframework:aws-predictions:1.35.2'
    implementation 'com.amplifyframework:aws-storage-s3:1.35.2'
}
```
