...
dependencies {
    ...
    implementation 'com.amplifyframework:aws-analytics-pinpoint:1.32.2'
    implementation 'com.amplifyframework:aws-api:1.32.2'
    implementation 'com.amplifyframework:aws-auth-cognito:1.32.2'
    implementation 'com.amplifyframework:aws-datastore:1.32.2'
    implementation 'com.amplifyframework:aws-predictions:1.32.2'
    implementation 'com.amplifyframework:aws-storage-s3:1.32.2'
}
```
