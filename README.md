...
dependencies {
    ...
    implementation 'com.amplifyframework:aws-analytics-pinpoint:2.38.1'
    implementation 'com.amplifyframework:aws-api:2.38.1'
    implementation 'com.amplifyframework:aws-auth-cognito:2.38.1'
    implementation 'com.amplifyframework:aws-datastore:2.38.1'
    implementation 'com.amplifyframework:aws-predictions:2.38.1'
    implementation 'com.amplifyframework:aws-storage-s3:2.38.1'
    implementation 'com.amplifyframework:aws-geo-location:2.38.1'
    implementation 'com.amplifyframework:aws-push-notifications-pinpoint:2.38.1'
}
```
