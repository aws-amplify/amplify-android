...
dependencies {
    ...
    implementation 'com.amplifyframework:aws-analytics-pinpoint:2.42.0'
    implementation 'com.amplifyframework:aws-api:2.42.0'
    implementation 'com.amplifyframework:aws-auth-cognito:2.42.0'
    implementation 'com.amplifyframework:aws-datastore:2.42.0'
    implementation 'com.amplifyframework:aws-predictions:2.42.0'
    implementation 'com.amplifyframework:aws-storage-s3:2.42.0'
    implementation 'com.amplifyframework:aws-geo-location:2.42.0'
    implementation 'com.amplifyframework:aws-push-notifications-pinpoint:2.42.0'
}
```
