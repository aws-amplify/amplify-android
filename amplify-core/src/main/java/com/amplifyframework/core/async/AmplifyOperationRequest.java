 ...
 * @param <RequestOptions> The concrete type that adjusts the behavior of the request type.
 ...
 */
public abstract class AmplifyOperationRequest<RequestOptions> {
     ...
     */
    abstract RequestOptions getRequestOptions();
}
