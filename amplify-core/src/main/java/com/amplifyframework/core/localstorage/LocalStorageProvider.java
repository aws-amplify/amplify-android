...
public abstract class LocalStorageProvider extends ContentProvider {
    ...
    @Nullable
    @Override
    public abstract Cursor query(@NonNull Uri uri,
    ...
    @Nullable
    @Override
    public abstract Uri insert(@NonNull Uri uri,
