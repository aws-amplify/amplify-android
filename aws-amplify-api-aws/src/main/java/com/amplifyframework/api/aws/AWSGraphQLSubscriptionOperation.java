 ...
 */
public final class AWSGraphQLSubscriptionOperation<T> extends GraphQLOperation<T> {

    private static final String TAG = AWSGraphQLSubscriptionOperation.class.getSimpleName();
     ...
     */
    AWSGraphQLSubscriptionOperation(String endpoint,
                        OkHttpClient client,
