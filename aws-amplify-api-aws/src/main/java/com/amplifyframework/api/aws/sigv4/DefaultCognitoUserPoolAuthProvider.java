 ...
 */
public final class DefaultCognitoUserPoolAuthProvider implements CognitoUserPoolsAuthProvider {

    private static final String TAG = DefaultCognitoUserPoolAuthProvider.class.getSimpleName();
