...
final class ApiConfiguration {
    ...
    static final class Builder {
        ...
        Builder authType(@NonNull AuthType authType) {
            Builder.this.authType = Objects.requireNonNull(authType);
            return Builder.this;
        }
        ...
        ApiConfiguration build() {
            ...
            Objects.requireNonNull(Builder.this.authType);
