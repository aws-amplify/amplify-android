...
object SignInChallengeCognitoActions : SignInChallengeActions {
    override fun verifySignInChallenge(event: SignInChallengeEvent.EventType.VerifyChallengeAnswer) = Action<AuthEnvironment>("VerifySignInChallenge") { id, dispatcher ->
