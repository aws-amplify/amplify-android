...
public final class AWSCognitoAuthConfirmResetPasswordOptions extends AuthConfirmResetPasswordOptions {
     ...
     */
    protected AWSCognitoAuthConfirmResetPasswordOptions(
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            AWSCognitoAuthConfirmResetPasswordOptions authConfirmResetPasswordOptions =
                    (AWSCognitoAuthConfirmResetPasswordOptions) obj;
            return ObjectsCompat.equals(getMetadata(), authConfirmResetPasswordOptions.getMetadata());
        }
    }

    @Override
    public String toString() {
        return "AWSCognitoAuthConfirmResetPasswordOptions{" +
                "metadata=" + metadata +
                '}';
    }
    ...
    public static final class CognitoBuilder extends Builder<CognitoBuilder> {
        ...
        public AWSCognitoAuthConfirmResetPasswordOptions build() {
            return new AWSCognitoAuthConfirmResetPasswordOptions(
