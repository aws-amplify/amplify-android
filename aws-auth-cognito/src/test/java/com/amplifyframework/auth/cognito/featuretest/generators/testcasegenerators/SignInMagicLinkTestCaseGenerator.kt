...
object SignInMagicLinkTestCaseGenerator : SerializableProvider {
    ...
    private val baseCase = FeatureTestCase(
        description = "Test that SignIn with magic link invokes proper cognito request and returns success",
