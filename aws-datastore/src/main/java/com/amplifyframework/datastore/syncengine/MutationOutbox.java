...
interface MutationOutbox {
     ...
     * @param modelClass The fully qualified class name of the model for which you want to check pending mutations. This should match the name returned by the model's getClass().getName() method.
