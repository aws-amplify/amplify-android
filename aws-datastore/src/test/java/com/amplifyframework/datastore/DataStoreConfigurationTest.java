...
import com.amplifyframework.datastore.DataStoreConflictHandlers.AlwaysApplyRemoteHandler;
...
public final class DataStoreConfigurationTest {
    ...
    public void testDefaultConfiguration() throws DataStoreException {
        ...
        assertTrue(dataStoreConfiguration.getDataStoreConflictHandler() instanceof AlwaysApplyRemoteHandler);
