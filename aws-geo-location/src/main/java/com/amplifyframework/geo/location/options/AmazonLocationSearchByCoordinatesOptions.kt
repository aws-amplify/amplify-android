...
class AmazonLocationSearchByCoordinatesOptions private constructor(
    ...
    class Builder : GeoSearchByCoordinatesOptions.Builder() {
        var searchIndex: String? = null
            private set
        fun searchIndex(searchIndex: String) = apply { this.searchIndex = searchIndex }
        override fun build() = AmazonLocationSearchByCoordinatesOptions(searchIndex, this)
    }
}