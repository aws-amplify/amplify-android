...
public class AmplifyFirehoseClientOptionsJavaTest {
    ...
    public void configureClientConfiguresSdkClient() {
        ...
        AmplifyFirehoseClient client = new AmplifyFirehoseClient(
                context,
                "us-east-1",
                fakeCredentials,
                AmplifyFirehoseClientOptions.builder()
                        .maxRetries(3)
        ...
        assertNotNull(client.getFirehoseClient());
        assertEquals(10, client.getFirehoseClient().getConfig().getRetryStrategy().getConfig().getMaxAttempts());
    }
}
