...
class AmplifyFirehoseClientOptionsTest {
    ...
    fun `configureClient DSL configures SDK client`() {
        ...
        val client = AmplifyFirehoseClient(
            context = context,
            region = "us-east-1",
        ...
        client.firehoseClient.shouldNotBeNull()
        client.firehoseClient.config.retryStrategy.config.maxAttempts shouldBe 10
    }
}
