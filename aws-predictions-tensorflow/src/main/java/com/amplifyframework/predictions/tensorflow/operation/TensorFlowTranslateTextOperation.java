...
/**
 * Operation to translate text in an offline state is currently not
 * supported. This operation will immediately trigger error callback
 * upon being started.
 */
public final class TensorFlowTranslateTextOperation
        extends TranslateTextOperation<TensorFlowUnsupportedRequest> {
    private final Consumer<PredictionsException> onError;

    /**
     * Constructs an instance of {@link TensorFlowTranslateTextOperation}.
     * @param onError lambda to execute upon task start
     */
    public TensorFlowTranslateTextOperation(@NonNull Consumer<PredictionsException> onError) {
