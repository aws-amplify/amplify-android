...
fun StoragePathValidationException.Companion.invalidStoragePathException() = StorageException(
...
fun StoragePathValidationException.Companion.unsupportedStoragePathException() = StorageException(
