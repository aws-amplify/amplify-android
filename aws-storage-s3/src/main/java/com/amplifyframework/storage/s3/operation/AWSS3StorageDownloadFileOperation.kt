 ...
 */
@Deprecated(
    "Class should not be public and explicitly cast to. Cast to StorageDownloadFileOperation." +
        "Internal usages are moving to AWSS3StoragePathDownloadFileOperation"
)
