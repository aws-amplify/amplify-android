...
class AWSS3StorageUploadInputStreamOptionsTest {
     ...
     *
     * - Given: the default instance of [AWSS3StorageUploadInputStreamOptions]
    ...
    fun `default progressStallTimeout is null so plugin default applies`() {
        val options = AWSS3StorageUploadInputStreamOptions.defaultInstance()
    ...
    fun `from copies progressStallTimeout`() {
        val original = AWSS3StorageUploadInputStreamOptions.builder()
            .progressStallTimeout(ProgressStallTimeout.Interval(seconds = 5L))
            .build()
        val clone = AWSS3StorageUploadInputStreamOptions.from(original).build()
    ...
    fun `equals and hashCode account for progressStallTimeout`() {
        val a = AWSS3StorageUploadInputStreamOptions.builder()
            .progressStallTimeout(ProgressStallTimeout.Interval(seconds = 10L))
            .build()
        val b = AWSS3StorageUploadInputStreamOptions.builder()
            .progressStallTimeout(ProgressStallTimeout.Disabled)
            .build()
        (a == b) shouldBe false
