## [Release 0.23.0](https://github.com/aws-amplify/amplify-android/releases/tag/release-kotlin_v0.23.0)
...
- **datastore:** Add recoverability improvements (v1) ([#2268](https://github.com/aws-amplify/amplify-android/issues/2268))
...
- **core:** remove unused dynamic nav dependency ([#2131](https://github.com/aws-amplify/amplify-android/issues/2131))
- **datastore:** remove typename from ModelMetadata ([#2122](https://github.com/aws-amplify/amplify-android/issues/2122)) ([#2166](https://github.com/aws-amplify/amplify-android/issues/2166))
- **datastore:** Fix lock contention issue when running DataStore.start() from the callback of DataStore.stop() ([#2209](https://github.com/aws-amplify/amplify-android/issues/2209))
- **Storage:** Prevent re-binding transferService after it is initialized ([#2211](https://github.com/aws-amplify/amplify-android/issues/2211))
...
- Update build.gradle ([#2101](https://github.com/aws-amplify/amplify-android/issues/2101))
- Update release_pr.yml ([#2106](https://github.com/aws-amplify/amplify-android/issues/2106))
- release: Amplify Android 1.37.7 ([#2107](https://github.com/aws-amplify/amplify-android/issues/2107))
- Update build.gradle ([#2118](https://github.com/aws-amplify/amplify-android/issues/2118))
- release: Amplify Android 1.37.8 ([#2121](https://github.com/aws-amplify/amplify-android/issues/2121))
- Bumping to AWS SDK 2.59 to support hyd launch ([#2134](https://github.com/aws-amplify/amplify-android/issues/2134))
- release: Amplify Android 1.37.9 ([#2135](https://github.com/aws-amplify/amplify-android/issues/2135))
- Update DeviceFarm build config ([#2169](https://github.com/aws-amplify/amplify-android/issues/2169))
- bump sdk version ([#2175](https://github.com/aws-amplify/amplify-android/issues/2175))
- release: Amplify Android 1.37.10 ([#2176](https://github.com/aws-amplify/amplify-android/issues/2176))
- Increase Geo timeout so that it runs more consistently ([#2181](https://github.com/aws-amplify/amplify-android/issues/2181))
- release: Amplify Android 1.37.11 ([#2216](https://github.com/aws-amplify/amplify-android/issues/2216))
- Update build.gradle ([#2241](https://github.com/aws-amplify/amplify-android/issues/2241))
- release: Amplify Android 1.37.12 ([#2244](https://github.com/aws-amplify/amplify-android/issues/2244))
- Update build.gradle ([#2246](https://github.com/aws-amplify/amplify-android/issues/2246))
- release: Amplify Android 1.37.13 ([#2248](https://github.com/aws-amplify/amplify-android/issues/2248))
- release: Amplify Android 1.38.0 ([#2272](https://github.com/aws-amplify/amplify-android/issues/2272))
- release: Amplify Android 1.38.1 ([#2314](https://github.com/aws-amplify/amplify-android/issues/2314))
- Use instr() for string checking v1 ([#2346](https://github.com/aws-amplify/amplify-android/issues/2346))
- release: Amplify Android 1.38.2 ([#2357](https://github.com/aws-amplify/amplify-android/issues/2357))
- Use better fallback for list query v1 ([#2345](https://github.com/aws-amplify/amplify-android/issues/2345))

[See all changes between 0.22.2 and 0.23.0](https://github.com/aws-amplify/amplify-android/compare/release-kotlin_v0.22.2...release-kotlin_v0.23.0)
...
[See all changes between 0.21.8 and 0.21.9](https://github.com/aws-amplify/amplify-android/compare/release-kotlin_v0.21.8...release-kotlin_v0.21.9)
