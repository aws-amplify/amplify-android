...
/**
 * Auth exception caused by a user not being authorized
...
open class NotAuthorizedException(
    message: String = "Failed since user is not authorized.",
    recoverySuggestion: String = "Check whether the given values are correct and the user is authorized to " +
