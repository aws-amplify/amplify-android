...
/**
 * Auth exception caused by being unable to get valid credentials until the user signs in again.
...
open class SessionExpiredException(
    ...
    recoverySuggestion: String = "Please sign in and reattempt the operation.",
