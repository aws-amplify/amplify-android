...
public abstract class AuthMagicLinkOptions {
     ...
     * The only way to create this is by calling {@link AuthMagicLinkOptions#defaults()}.
     */
    public static final class DefaultAuthMagicLinkOptions extends AuthMagicLinkOptions {
        private DefaultAuthMagicLinkOptions() {}

        @Override
        public int hashCode() {
            return DefaultAuthMagicLinkOptions.class.hashCode();
        }

        @Override
        public boolean equals(@Nullable Object obj) {
            return obj instanceof DefaultAuthMagicLinkOptions;
        }

        @NonNull
        @Override
        public String toString() {
            return DefaultAuthMagicLinkOptions.class.getSimpleName();
        }
    }
}
