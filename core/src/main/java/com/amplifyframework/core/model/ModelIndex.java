...
public final class ModelIndex {
    ...
    public boolean equals(Object thatObject) {
        ...
        ModelIndex that = (ModelIndex) thatObject;

        if (!ObjectsCompat.equals(indexName, that.indexName)) {
            return false;
        }
        return ObjectsCompat.equals(indexFieldNames, that.indexFieldNames);
    }

    @Override
    public int hashCode() {
        int result = indexName != null ? indexName.hashCode() : 0;
        result = 31 * result + (indexFieldNames != null ? indexFieldNames.hashCode() : 0);
        return result;
    }
