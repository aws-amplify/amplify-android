...
/**
 * Exception thrown by {@link ModelSchema} operations.
 */
public final class ModelSchemaException extends AmplifyRuntimeException {
     ...
     */
    public ModelSchemaException(String message, Throwable throwable) {
     ...
     */
    public ModelSchemaException(Throwable throwable) {
        super(throwable);
    }
}
