...
/** This is an auto generated class representing the TextTemplateLocale type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "TextTemplateLocales", authRules = {
...
@Index(name = "byTextTemplate", fields = {"materialID"})
public final class TextTemplateLocale implements Model {
  public static final QueryField ID = field("TextTemplateLocale", "id");
  public static final QueryField LOCALE = field("TextTemplateLocale", "locale");
  public static final QueryField MATERIAL_ID = field("TextTemplateLocale", "materialID");
  public static final QueryField NAME = field("TextTemplateLocale", "name");
  public static final QueryField SORT = field("TextTemplateLocale", "sort");
  public static final QueryField ONLINE = field("TextTemplateLocale", "online");
  public static final QueryField UPDATED_AT = field("TextTemplateLocale", "updatedAt");
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), textTemplateLocale.getId()) &&
              ObjectsCompat.equals(getLocale(), textTemplateLocale.getLocale()) &&
              ObjectsCompat.equals(getMaterialId(), textTemplateLocale.getMaterialId()) &&
   ...
   */
  public static TextTemplateLocale justId(String id) {
    return new TextTemplateLocale(
      id,
      null,
      null,
      null,
