...
/** This is an auto generated class representing the TransitionVFXCategoryLocale type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "TransitionVFXCategoryLocales", authRules = {
...
@Index(name = "byTransitionVFXCategory", fields = {"materialID"})
public final class TransitionVFXCategoryLocale implements Model {
  public static final QueryField ID = field("TransitionVFXCategoryLocale", "id");
  public static final QueryField LOCALE = field("TransitionVFXCategoryLocale", "locale");
  public static final QueryField MATERIAL_ID = field("TransitionVFXCategoryLocale", "materialID");
  public static final QueryField NAME = field("TransitionVFXCategoryLocale", "name");
  public static final QueryField SORT = field("TransitionVFXCategoryLocale", "sort");
  public static final QueryField ONLINE = field("TransitionVFXCategoryLocale", "online");
  public static final QueryField UPDATED_AT = field("TransitionVFXCategoryLocale", "updatedAt");
  ...
  private TransitionVFXCategoryLocale(String id, String locale, String materialID, String name, Integer sort, Integer online, Temporal.DateTime updatedAt) {
    this.id = id;
    this.locale = locale;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), transitionVfxCategoryLocale.getId()) &&
              ObjectsCompat.equals(getLocale(), transitionVfxCategoryLocale.getLocale()) &&
              ObjectsCompat.equals(getMaterialId(), transitionVfxCategoryLocale.getMaterialId()) &&
              ObjectsCompat.equals(getName(), transitionVfxCategoryLocale.getName()) &&
              ObjectsCompat.equals(getSort(), transitionVfxCategoryLocale.getSort()) &&
              ObjectsCompat.equals(getOnline(), transitionVfxCategoryLocale.getOnline()) &&
              ObjectsCompat.equals(getUpdatedAt(), transitionVfxCategoryLocale.getUpdatedAt()) &&
              ObjectsCompat.equals(getCreatedAt(), transitionVfxCategoryLocale.getCreatedAt());
      }
  }
  ...
  @Override
   public String toString() {
    return new StringBuilder()
      .append("TransitionVFXCategoryLocale {")
   ...
   */
  public static TransitionVFXCategoryLocale justId(String id) {
    return new TransitionVFXCategoryLocale(
      id,
      null,
      null,
      null,
