 ...
 */
@SuppressWarnings({"unused", "WeakerAccess"}) // These are all public APIs.
public final class RxAmplify {

    @SuppressWarnings("checkstyle:all") private RxAmplify() {}

    @SuppressWarnings("checkstyle:all") public static final RxApi API = new RxApiBinding();
    @SuppressWarnings("checkstyle:all") public static final RxDataStore DataStore = new RxDataStoreBinding();
    @SuppressWarnings("checkstyle:all") public static final RxHub Hub = new RxHubBinding();
    @SuppressWarnings("checkstyle:all") public static final RxStorage Storage = new RxStorageBinding();
