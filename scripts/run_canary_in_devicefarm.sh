...
run_arn=$(aws devicefarm schedule-run --project-arn=$project_arn \
                                      ...
                                      --name="$file_name-$CODEBUILD_SOURCE_VERSION" \
                                      --test="type=INSTRUMENTATION,testPackageArn=$test_package_upload_arn,parameter="filter":"com.amplifyframework.auth.cognito.AuthCanaryTest, com.amplifyframework.datastore.DatastoreCanaryTest"" \
