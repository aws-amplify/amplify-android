...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("dependency") {
             ...
             */
            version(awsKotlinSdk, "0.22.1-beta") // ensure proper awsSmithyKotlin version also set
            version(awsSmithyKotlin, "0.17.2") // ensure proper awsKotlinSdk version also set
