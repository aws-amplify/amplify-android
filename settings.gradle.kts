...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        ...
        create("dependency") {
             ...
             */
            version(awsKotlinSdk, "0.27.0-beta") // ensure proper awsSmithyKotlin version also set
            version(awsSmithyKotlin, "0.21.2") // ensure proper awsKotlinSdk version also set
