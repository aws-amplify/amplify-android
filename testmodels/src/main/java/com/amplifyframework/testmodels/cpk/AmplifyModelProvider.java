  ...
  @Override
   public Set<Class<? extends Model>> models() {
    final Set<Class<? extends Model>> modifiableSet = new HashSet<>(
          Arrays.<Class<? extends Model>>asList(Blog.class, Post.class, User.class, Comment.class, Item.class,
                  IntModelWithIdentifier.class, StringModelWithIdentifier.class, BlogOwnerCPK.class,
                  BlogCPK.class, PostCPK.class)
        );
