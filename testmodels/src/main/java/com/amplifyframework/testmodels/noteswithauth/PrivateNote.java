...
@ModelConfig(pluralName = "PrivateNotes")
public final class PrivateNote implements Model {
  ...
  private PrivateNote(String id, String content) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      PrivateNote privateNote = (PrivateNote) obj;
      return ObjectsCompat.equals(getId(), privateNote.getId()) &&
              ObjectsCompat.equals(getContent(), privateNote.getContent());
      }
  }
   ...
   **/
  public static PrivateNote justId(String id) {
    try {
