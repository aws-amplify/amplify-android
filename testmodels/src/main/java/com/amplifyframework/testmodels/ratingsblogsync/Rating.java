...
package com.amplifyframework.testmodels.ratingsblogsync;
...
public final class Rating implements Model {
    ...
    public static final QueryField STARS = field("stars");
    public static final QueryField POST = field("ratingPostId");
