...
public final class SynchronousAWSMobileClient {
    private final AWSMobileClient awsMobileClient;

    private SynchronousAWSMobileClient(AWSMobileClient awsMobileClient) {
        this.awsMobileClient = awsMobileClient;
    }

    /**
     * Creates an instance of the {@link SynchronousAWSMobileClient}, using the
     * default instance of the {@link AWSMobileClient} as provided by {@link AWSMobileClient#getInstance()}.
     * @return A {@link SynchronousAWSMobileClient} using the default {@link AWSMobileClient}
     */
    @NonNull
    public static SynchronousAWSMobileClient instance() {
        return new SynchronousAWSMobileClient(AWSMobileClient.getInstance());
    }

    /**
     * Creates an instance of the {@link SynchronousAWSMobileClient}, using a provided
     * {@link AWSMobileClient} as a delegate.
     * @param awsMobileClient Client to which requests are delegated
     * @return A {@link SynchronousAWSMobileClient} which delegates to the provided AWSMobileClient
     */
    @NonNull
    public static SynchronousAWSMobileClient instance(@NonNull AWSMobileClient awsMobileClient) {
        return new SynchronousAWSMobileClient(Objects.requireNonNull(awsMobileClient));
    }
    ...
    @NonNull
    public UserStateDetails initialize(@NonNull AWSConfiguration awsConfiguration) throws MobileClientException {
